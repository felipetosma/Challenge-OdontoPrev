CREATE OR REPLACE PACKAGE pkg_AllPcdr_OdontoFast IS
...
END pkg_AllPcdr_OdontoFast;
/

CREATE OR REPLACE PACKAGE BODY pkg_AllPcdr_OdontoFast IS
    ...
    BEGIN
        ...
        ELSIF v_operacao = 'UPDATE' THEN
            ...
            IF SQL%ROWCOUNT = 0 THEN
                RAISE_APPLICATION_ERROR(-20004, 'Usuário não encontrado para atualização.');
            END IF;
        ...
        ELSIF v_operacao = 'DELETE' THEN
            ...
            IF SQL%ROWCOUNT = 0 THEN
                RAISE_APPLICATION_ERROR(-20005, 'Usuário não encontrado para exclusão.');
            END IF;
        ...
        ELSIF v_operacao = 'SELECT' THEN
            ...
            EXCEPTION
                WHEN NO_DATA_FOUND THEN
                    RAISE_APPLICATION_ERROR(-20006, 'Usuário não encontrado com o ID especificado.');
            END;
    ...
    EXCEPTION
        WHEN OTHERS THEN
            ROLLBACK;
            RAISE; -- Propaga a exceção para ser capturada pelo Java
    END crud_usuario;
