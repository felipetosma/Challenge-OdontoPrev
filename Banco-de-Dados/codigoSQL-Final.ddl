...
CREATE TABLE c_op_checklist (
    ...
    nivel            NUMBER(100),
    escovacao_dentes NUMBER(100),
    fio_dental       NUMBER(100),
    enxaguante_bucal NUMBER(100),
    id_usuario       NUMBER(30) NOT NULL
)
LOGGING;
...
ALTER TABLE c_op_dentista_planosaude ADD CONSTRAINT c_op_dentista_planosaude_pk PRIMARY KEY ( id_plano,
                                                                                              id_dentista );
------------------------------------------------------------------------------------------------------
